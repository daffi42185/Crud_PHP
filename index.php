...
// 1. Mengubah nama tabel dari tb_sekolah menjadi siswa
    ...
    <!-- Judul -->
     <div class="container">
        ...
        <table class="table align-middle table-bordered table-hover">
            <thead>
            <tr>
                <!-- 2. Menyesuaikan judul kolom pada tabel HTML -->
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <!-- 3. Memanggil nama field yang sesuai dengan databasemu -->
                    ...
                    <td>
                        <!-- 4. Mengganti id_siswa menjadi NISN untuk proses Ubah dan Hapus -->
